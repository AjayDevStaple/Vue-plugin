<template>
    <div class="register"> 
        <div class="title2"> 
         <h1 class="mjTitle"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="">Inquiry and Cancellation</font></font></h1> 
        </div> 
        <div class="login"> 
         <form id="form1" name="form1" method="post" action="register_search_detail.php#sidebar_4"> 
          <div class="item"> 
           <ul> 
            <li class="custom-control custom-radio"> <input type="radio" id="loginID_1" name="idType" value="1" class="custom-control-input" onclick="show_birth(1)" checked=""> <label class="custom-control-label" for="loginID_1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">ID number</font></font></label> </li> 
            <li class="custom-control custom-radio"> <input type="radio" id="loginID_2" name="idType" value="99" class="custom-control-input" onclick="show_birth(2)"> <label class="custom-control-label" for="loginID_2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Medical record number</font></font></label> </li> 
            <li class="custom-control custom-radio"> <input type="radio" id="loginID_3" name="idType" value="5" class="custom-control-input" onclick="show_birth(3)"> <label class="custom-control-label" for="loginID_3"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">passport number</font></font></label> </li> 
            <li class="custom-control custom-radio"> <input type="radio" id="loginID_4" name="idType" value="5" class="custom-control-input" onclick="show_birth(4)"> <label class="custom-control-label" for="loginID_4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Residence card number</font></font></label> </li> 
           </ul> 
           <div class="form-group"> <label for="label"><i class="far fa-id-card"></i></label> 
            <input type="text" name="patData" id="patData" class="form-control" placeholder="Example: A123456789" onchange="chk_password(1)" onkeyup="input_strtoupper(this,event)"> <small id="patData_txt" class="red warning_txt"></small> 
           </div> 
          </div> 
          <div class="item"> 
          ...
          <div class="item" id="vip_password" style="display: none"> 
           <div class="form-group"> <label for="label"><i class="fas fa-lock"></i></label> 
            <input type="password" id="strPW" name="strPW" class="form-control input-datepicker" placeholder="please enter password" onkeydown="if(event.keyCode==13){sbForm();}"> <small id="strPW_txt" class="red warning_txt"></small> 
           </div> 
          </div> 
          <div class="btn-wrap"> <button type="button" onclick="sbForm();" id="confirm" class="btn-style"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Inquire</font></font></button> 
...
.bg-mask{background:linear-gradient(135deg,#eef5f3 0%,rgba(238,245,243,0.6) 100%),url(../../assets/sidebar-bg.png)left top/cover}
...
.siderbar-nav .item{overflow:hidden;padding:2px 0;box-shadow:5px 0 1px -4px rgba(255,255,255,0.5)}
...
/*頁尾*/
footer{position:relative;background:linear-gradient(135deg,#326c9e 0%,rgba(71,136,191,0.8) 100%),url(../../assets/sidebar-bg.png)center/cover;font-size:.9em;color:#fff}
...
.page-content .photo img + article:before{content:'';width:6px;height:40%;position:absolute;top:50%;left:0;background:#326C9E;background:linear-gradient(135deg,#326c9e 0%,rgba(71,136,191,0.8) 100%),url(../../assets/sidebar-bg.png)center/cover;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}
...
.aid .clock-area:before{content:'';z-index:-1;position:absolute;left:50%;top:50%;width:300px;height:300px;background:#f5f5f5;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);box-shadow:0 5px 12px rgba(0,0,0,0.15)}
...
.circle-moving .unit{position:absolute;left:50%;bottom:1.5rem;display:inline-block;padding:.2rem .75rem 0;border-radius:30px;border:solid 1px #333;color:#333;font-size:.9rem;line-height:1;-ms-transform:translate(-50%,0);-webkit-transform:translate(-50%,0);transform:translate(-50%,0)}
...
@media screen and (max-width: 991px){
    ...
    header.fixed .logo{width:200px}
    header .navbar-collapse{position:fixed;top: 70px;bottom:0;z-index:9999999;width:100%;padding-bottom:100px;overflow-y:scroll;background:linear-gradient(135deg,#447A6A 0%,rgba(68,122,106,0.7) 100%),url(../../assets/sidebar-bg.png)center/cover;background:#447a6a;}
...
@media screen and (min-width:769px){
    ...
    /*該看哪一科*/
    .subject-list .adult:before{content:'';z-index:-1;position:absolute;left:50%;top:50%;width:700px;height:700px;border-radius:100%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}
