    ...
    <div class="title2">
      ...
      <div class="login">
        <form
          ...
          name="form1"
          method="post"
          action="register_search_detail.php#sidebar_4"
        >
          <div class="item">
            <ul>
              <li class="custom-control custom-radio">
                <input
                  ...
                  onclick="show_birth(1)"
                  checked
                />
                <label class="custom-control-label" for="loginID_1"
                  ><font style="vertical-align: inherit"
                    ><font style="vertical-align: inherit">ID number</font></font
                  ></label
                >
              </li>
              <li class="custom-control custom-radio">
                <input
                  ...
                  value="99"
                  class="custom-control-input"
                  onclick="show_birth(2)"
                />
                <label class="custom-control-label" for="loginID_2"
                  ><font style="vertical-align: inherit"
                    ><font style="vertical-align: inherit"
                      >Medical record number</font
                    ></font
                  ></label
                >
              </li>
              ...
              <li class="custom-control custom-radio">
                <input
                  ...
                  value="5"
                  class="custom-control-input"
                  onclick="show_birth(4)"
                />
                <label class="custom-control-label" for="loginID_4"
                  ><font style="vertical-align: inherit"
                    ><font style="vertical-align: inherit"
                      >Residence card number</font
                    ></font
                  ></label
                >
              </li>
          ...
          <div class="item">
            <div class="form-group">
              ...
              <input
                ...
                onkeydown="if(event.keyCode==13){sbForm();}"
              />
          ...
          <div class="btn-wrap">
            ...
            >
              <font style="vertical-align: inherit"
                ><font style="vertical-align: inherit">Inquire</font></font
              >
            </button>
            ...
            <input
              type="hidden"
              name="csrf"
              value="bde99d1c575f517b0db290430c6399c704274e1f"
            />
...
export default {
  ...
  setup() {
    ...
    const getPosts = async (): Promise<WP_REST_API_Posts> => {
      ...
      return (
        await axios.get<WP_REST_API_Posts>(
          `${wpFrontendLocalizer.devApiUrl}/wp/v2/posts`
        )
      ).data;
    };
...
body.on header button.navbar-toggler span {
  position: absolute;
  left: 10%; /* border-bottom:solid 2px #fff */
}
...
.nav-style.owl-carousel .owl-nav button {
  ...
  color: #fff;
  text-align: center;
  line-height: 0; /* text-indent: 0; */ /* border-radius: 100%; */ /* transform: translateY(-50%); */
}
...
.hot-key ul {
  ...
  -ms-flex-pack: center;
  justify-content: center;
  box-shadow: 0 2px 12px 2px rgba(0, 0, 0, 0.5); /* border-radius: 7rem; */ /* border: solid 6px #ffffff; */
}
.hot-key ul li {
  border-top: 0;
  width: 25%;
...
footer .awards ul li .photo {
  /* width:90%; */ /* height: 100%; */ /* margin: auto; */ /* text-align: center; */
}
...
.copyright {
  background: #326c9e;
  color: #fff; /* text-align:center; */ /* padding:.5rem 15px; */
  font-size: 0.9rem;
}
.copyright .container {
  display: flex;
  ...
  align-items: center;
  padding-top: 0.5rem;
  padding-bottom: 0.5rem; /* max-width: 800px; */
}
.copyright a {
  color: #fff;
}
...
.btn-right {
  ...
  position: fixed;
  right: 5px;
  bottom: 90px; /* transform:translateY(-50%); */
  z-index: 10;
}
...
[class$="photo-list2"] article {
  font-size: 0.9rem; /* border-bottom:solid 3px #e0e0e0; */ /* padding-bottom:1em; */
  margin-bottom: 1em;
  position: relative;
  height: 30px;
  display: -webkit-box;
...
.phiz-area .tt {
  ...
  margin-right: 0.5rem;
  padding: 0 0.5rem;
  background: #f39118; /* font-size:1rem */
}
.phiz-area .phiz {
  display: inline-block;
  list-style: none;
